;(function ( $, window, document, undefined ) {
  $.widget('poker.main', {
    ...
    _create: function() {
      ...
      var lo = $("<div />").attr("id", "lobby-main").lobby();
      self._setOptions({wsock: ws, lobbyMain: lo});
    ...
    _recModal: function(t) {
      ...
      m.append(
        ...
        $("<button />").addClass("modal-ok").html("Reconnect")
        .click(function() {
          //m.empty();
          //m.hide();
          self.element.empty();
        ...
        $("<button />").addClass("modal-cancel").html("Cancel")
        .click(function() {
          self.destroy();
        })
      ).show();
